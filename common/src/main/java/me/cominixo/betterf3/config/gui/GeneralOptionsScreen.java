...
public final class GeneralOptionsScreen {
  ...
  public static ConfigBuilder configBuilder(final Screen parent) {
    ...
    general.addEntry(entryBuilder.startBooleanToggle(Text.translatable("config.betterf3.auto_start"), GeneralOptions.autoF3)
    .setDefaultValue(false)
    .setTooltip(Text.translatable("config.betterf3.auto_start.tooltip"))
    ...
    general.addEntry(entryBuilder.startBooleanToggle(Text.translatable("config.betterf3.debug_crosshair"), GeneralOptions.hideDebugCrosshair)
    .setDefaultValue(false)
    .setTooltip(Text.translatable("config.betterf3.debug_crosshair.tooltip"))
