...
public class ModConfigScreen extends Screen {
    ...
    public void init() {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 130, this.height - 50, 260, 20, new TranslatableText("config.me.cominixo.betterf3.modules.done_button"), (buttonWidget) -> client.openScreen(null)));
